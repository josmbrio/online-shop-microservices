...
helm install -f values/ad-service-values.yaml emailservice charts/microservice
...
helm install -f values/shipping-service-values.yaml chippingservice charts/microservice
